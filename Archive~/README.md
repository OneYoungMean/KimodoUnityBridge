...
also excludes this repository-level directory.

The handle/download protocol remains retired; its removed implementation is
available from Git history rather than duplicated here.
